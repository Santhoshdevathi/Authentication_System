    ...
    return (
        <nav className="navbar bg-white px-5 py-4 d-flex justify-content-between align-items-center">
            ...
            <div className="position-relative" ref={dropDownRef}>
                <div className="bg-dark text-white rounded-circle d-flex justify-content-center align-items-center right-0"
            ...
            : 
            <div className="btn btn-outline-dark rounded-pill px-3 position-absolute top-20 end-0 m-3" onClick={() => navigate("/login")}>
